...
setwd('C:/Bryan/EPA/Manuscripts/PlosOne2013') #set working directory to output figures and tables
#Get the InOut data
load(file='PlosOne20121129.rda') #NOTE: this will need to be updated to the PlosOne URL
