...
par(mfrow=c(2,3))
compCDF(NLA$Nout*1000,MRB1$Nout*1000,c(1.75,4),'Nout','orange')
  legend("bottomright",c("NLA 95% c.i.","MRB1"),
        pch=19,cex=1.4,col=c('ivory3','orange'),bty='n')
  title(main="Predicted Nitrogen Output") 
compCDF(NLA$NTL,lmNugl,c(1.75,4),'lmNTL','orange')
  legend("bottomright",c("NLA 95% c.i.","MRB1"),
        pch=19,cex=1.4,col=c('ivory3','orange'),bty='n')
  title(main="NLA Obs. vs. MRB1 Pred. Nitrogen") 
...
compCDF(NLA$PTL,lmPugl,c(0,3),'lmPTL','orange')
  legend("bottomright",c("NLA 95% c.i.","MRB1"),
        pch=19,cex=1.4,col=c('ivory3','orange'),bty='n')
  title(main="NLA Obs. vs. MRB1 Pred. Phosphorus") 
