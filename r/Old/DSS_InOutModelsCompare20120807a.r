...
v='DSS_InOutModelsCompare20120807a.r'
...
#Eliminate Lake Champlain lakes where SPARROW predictions Nin doesn't equal Nout
MRB1<-One[round(One$Nin)==round(One$Nout) & One$WB_ID!=22302965,]

#Select the NLA data only from MRB1
...
P<- ModelSearch('PinMRB1','PoutMRB1','TP',NLA)
P
N<- ModelSearch('NinMRB1','NoutMRB1','TN',One[Select,])
N 
