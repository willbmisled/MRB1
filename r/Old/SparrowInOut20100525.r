...
#Calculated Fields
    ...
    plot(VolumeNLA,VolumeGIS)
    abline(0,1)
    plot(hrtNLA,hrtGIS)
    plot(VolumeNLA,hrtGIS)
    
    hrtNLA[WB_ID==9512548]
    hrtGIS[WB_ID==9512548]
    VolumeNLA[WB_ID==9512548]
    VolumeGIS[WB_ID==9512548]
    Area[WB_ID==9512548]
    Outflow[WB_ID==9512548]
    Inflow[WB_ID==9512548]
    ZMax_NLA[WB_ID==9512548]
    ZMax_GIS[WB_ID==9512548]
