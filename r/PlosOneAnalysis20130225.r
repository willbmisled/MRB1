...
win.graph()
par(mai=Mai)
PlotNL(nln,Nin,TN,'TN','a) Total Nitrogen: Non-linear Model','T') 
#Figure 4b: Phosphorus
win.graph()
par(mai=Mai)
PlotNL(nlp,Pin,TP,'TP','b) Total Phosphorus: Non-linear Model','F')  
axis(1,at=c(.002,.006,.020,.06,.2,.6,2),cex.axis=1.2)
axis(2,at=c(.002,.006,.020,.06,.2,.6,2),cex.axis=1.2)
box()
...
plot(hrt,nln$residuals,pch=19,col=group,xlim=c(0,5),ylim=c(-.7,.8),
  xlab='Hydraulic Residence Time (years)',ylab='Residuals',
  main='b) Total Nitrogen: Non-linear Model Residuals',cex=1.3,cex.lab=1.5,cex.axis=1.1,cex.main=1.3)
  abline(h=0,lwd=2,col="grey")
...
plot(hrt,nlp$residuals,pch=19,col=group,xlim=c(0,5),ylim=c(-.9,1.2),
  xlab='Hydraulic Residence Time (years)',ylab='Residuals',
  main='d) Total Phosphorus: Non-linear Model Residuals',cex=1.3,cex.lab=1.5,cex.axis=1.1,cex.main=1.3)
  abline(h=0,lwd=2,col="grey")
