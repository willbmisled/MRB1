...
v='DSS_InOutModelSelection20121004.r'
...
#Select the NLA data only from MRB1  n=131
...
#save the data
#save(LMN,nln,LMP,nlp,MRB1,NLA,file='C:/Bryan/EPA/Data/RData/InOutModelSelection20121004.rda')
